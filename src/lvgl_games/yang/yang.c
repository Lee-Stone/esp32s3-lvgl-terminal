...
#define right_count         14
#define mid_count           100
#define bottom_count        7
#define max_layer           3
#define layer_row_count     3
#define layer_col_count     3
#define mid_x_start         90
#define mid_y_start         5
#define card_width          40
#define card_height         50
#define left_x_start        5
#define right_x_start       275
#define left_y_start        15
#define right_y_start       15
#define left_y_distance     5
#define right_y_distance    5
#define bottom_start_x      16
#define bottom_start_y      155
